...
<div class="container-fluid">
      ...
      <div class="card shadow mb-4">
        ...
        <div class="card-body">
          ...
          <div class="mt-4 text-center small">
            <span class="mr-2">
              <i class="fas fa-circle text-primary"></i> Lensa
            </span>
            <span class="mr-2">
              <i class="fas fa-circle text-success"></i> Kamera
            </span>
            <span class="mr-2">
              <i class="fas fa-circle text-info"></i> Jasa Foto
            </span>
          </div>
        </div>
      </div>
  ...
  <div class="row">
    ...
    <div class="col-lg-6 mb-4">
      ...
      <div class="card shadow mb-4">
        <div class="card-header py-3">
          <h6 class="m-0 font-weight-bold text-primary">Banyak Penyewa</h6>
        </div>
        <div class="card-body">
          ...
          <p>Banyaknya penyewa pada setiap bulan</p>
