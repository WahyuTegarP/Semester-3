<div class="hero-wrap ftco-degree-bg" style="background-image: url('assets/user/images/IMG_6698.jpg');"
    ...
    <div class="row no-gutters slider-text justify-content-start align-items-center justify-content-center">
      <div class="col-lg-8 ftco-animate">
        <div class="text w-100 text-center mb-md-5 pb-md-5">
          <h1 class="mb-4">Cepat &amp; Cara Mudah Menyewa Kamera & Studio!</h1>
            ...
            <div class="services-wrap rounded-right w-100">
              ...
              <div class="row d-flex mb-4">
                ...
                <div class="col-md-4 d-flex align-self-stretch ftco-animate">
                  <div class="services w-100 text-center">
                    <div class="icon d-flex align-items-center justify-content-center">
                      <i class="bi bi-camera" style="color: #1089ff; font-size: 2rem;"></i>
                      <!-- Ukuran lebih besar -->
                    </div>
                    <div class="text w-100">
      ...
      <div class="col-md-12">
        <div class="carousel-car owl-carousel">
          <div class="item">
            <div class="car-wrap rounded ftco-animate">
              <div class="img rounded d-flex align-items-end"
                style="background-image: url(assets/user/images/A7_3.jpg);">
              </div>
              <div class="text">
          ...
          <div class="item">
            <div class="car-wrap rounded ftco-animate">
              <div class="img rounded d-flex align-items-end"
                style="background-image: url(assets/user/images/A7_2.jpg);">
              </div>
              <div class="text">
          ...
          <div class="item">
            <div class="car-wrap rounded ftco-animate">
              <div class="img rounded d-flex align-items-end"
                style="background-image: url(assets/user/images/A6400.jpg);">
              </div>
              <div class="text">
  ...
  <div class="container">
    <div class="row no-gutters">
      <div class="col-md-6 p-md-5 img img-2 d-flex justify-content-center align-items-center"
        style="background-image: url(assets/user/images/IMG_6698.jpg);">
      </div>
      <div class="col-md-6 wrap-about ftco-animate">
        <div class="heading-section heading-section-white pl-md-5">
          <span class="subheading">Tentang kita</span>
          <h2 class="mb-4">Selamat datang di BiruhijauStudio!</h2>

          <p>Sebuah lokasi kecil bernama Rembangan yang terletak di dekat Kecamatan Patrang, Desa Baratan dan
            menyediakan berbagai kebutuhan untuk produksi Anda. Ini adalah tempat yang mudah dan lengkap untuk
            menemani kegiatan produksi Anda.</p>
          <p>Sebuah tempat yang direkomendasikan kepada masyarakat untuk dipercaya menyediakan hasil momen renungan
  ...
  <div class="container">
    <div class="row justify-content-center mb-5">
      <div class="col-md-7 text-center heading-section ftco-animate">
        ...
        <h2 class="mb-3">Tentang Layanan Kita!</h2>
      </div>
    </div>
    <div class="row">
      <div class="col-md-3">
        <div class="services services-2 w-100 text-center">
          ...
          <div class="text w-100">
            <h3 class="heading mb-2">Layanan Pernikahan</h3>
            <p>Kita melayani persewaan untuk kebutuhan acara mulai dari acara pernikahan hingga acara prewedding
              dengan alat yang istimewa dan professional.</p>
          </div>
        </div>
      </div>
      <div class="col-md-3">
        <div class="services services-2 w-100 text-center">
          ...
          <div class="text w-100">
            <h3 class="heading mb-2">Produksi untuk Agensi</h3>
            <p>Kita juga melayani persewaan untuk kebutuhan instansi dengan balutan acara resmi dengan menggunakan
              alat yang istimewa dan professional dari persewaan kami.</p>
          </div>
        </div>
      </div>
      <div class="col-md-3">
        <div class="services services-2 w-100 text-center">
          ...
          <div class="text w-100">
            <h3 class="heading mb-2">Momen Pre-wedding</h3>
            <p>Kita juga melayani persewaan untuk kebutuhan prewedding dengan menggunakan alat yang istimewa dan
              professional dari persewaan kami. Sehingga dapat menjadikan hasil yang sangat menawan.</p>
          </div>
        </div>
      </div>
      <div class="col-md-3">
        <div class="services services-2 w-100 text-center">
          <div class="icon d-flex align-items-center justify-content-center"><span
              class="flaticon-transportation"></span></div>
          <div class="text w-100">
            <h3 class="heading mb-2">Momen Kelulusan</h3>
            <p>Kita juga melayani persewaan untuk kebutuhan acara kelulusan dengan menggunakan alat yang istimewa dan
              professional dari persewaan kami. Sehingga dapat menjadikan hasil yang sangat elegan, menawan, dan
              meriah.</p>
          </div>
        </div>
      </div>
...
<div class="container">
        ...
        <div class="row d-flex">
          <div class="col-md-4 d-flex ftco-animate">
              ...
              <a href="blog-single.html" class="block-20" style="background-image: url('assets/user/images/IMG_6698.jpg');">
              </a>
              <div class="text pt-4">
              	<div class="meta mb-3">
                ...
                <p><a href="?hal=blog" class="btn btn-primary">Baca selengkapnya</a></p>
              </div>
            </div>
          </div>
          <div class="col-md-4 d-flex ftco-animate">
          	<div class="blog-entry justify-content-end">
              <a href="blog-single.html" class="block-20" style="background-image: url('assets/user/images/IMG_6704.jpg');">
              </a>
              <div class="text pt-4">
              	<div class="meta mb-3">
          ...
          <div class="col-md-4 d-flex ftco-animate">
              ...
              <a href="blog-single.html" class="block-20" style="background-image: url('assets/user/images/IMG_6691.jpg');">
              </a>
              <div class="text pt-4">
              	<div class="meta mb-3">
