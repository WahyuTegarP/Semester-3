	...
	<div class="col-md-3">
		<div class="services services-2 w-100 text-center">
			<div class="icon d-flex align-items-center justify-content-center">
				<img src="assets/user/images/wedding-car.png" alt="Wedding Icon" class="rounded-img">
			</div>
	...
	<div class="col-md-3">
		<div class="services services-2 w-100 text-center">
			<div class="icon d-flex align-items-center justify-content-center">
				<img src="assets/user/images/travel-and-tourism.png" alt="Study Tour Icon" class="rounded-img">
			</div>
			<div class="text w-100">
				<h3 class="heading mb-2">Study Tour</h3>
				<p>A small river named Duden flows by their place and supplies it with the necessary regelialia.</p>
			</div>
		</div>
	</div>
	<div class="col-md-3">
		<div class="services services-2 w-100 text-center">
			<div class="icon d-flex align-items-center justify-content-center">
				<img src="assets/user/images/diaphragm.png" alt="Rental Kamera Icon" class="rounded-img">
			</div>
			<div class="text w-100">
				<h3 class="heading mb-2">Rental Kamera & Aksesoris Kamera</h3>
				<p>A small river named Duden flows by their place and supplies it with the necessary regelialia.</p>
			</div>
		</div>
	</div>
	<div class="col-md-3">
		...
		<section class="ftco-section ftco-intro" style="background-image: url('assets/user/images/IMG_6703.jpg');">
			<div class="overlay"></div>
			<div class="container">
