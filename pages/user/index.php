        ...
        <div class="row no-gutters slider-text justify-content-start align-items-center justify-content-center">
          <div class="col-lg-8 ftco-animate">
          	<div class="text w-100 text-center mb-md-5 pb-md-5">
	            ...
	            <p style="font-size: 18px;">Sebuah lokasi kecil bernama Rembangan yang terletak di dekat Kecamatan Patrang, Desa Baratan dan menyediakan berbagai kebutuhan produksi Anda. Ini adalah tempat yang mudah dan lengkap untuk menemani kegiatan produksi Anda.</p>
  ...
  <div class="services w-100 text-center">
    <div class="icon d-flex align-items-center justify-content-center">
      <i class="bi bi-camera" style="color: #1089ff; font-size: 2rem;"></i> <!-- Ukuran lebih besar -->
    </div>
    <div class="text w-100">
      <h3 class="heading mb-2">Reserve Your Rental Camera</h3>
					        ...
					        <p><a href="#" class="btn btn-primary py-3 px-4">Reserve Your Perfect Camera</a></p>
	  						</div>
	  					</div>
	  				</div>
				</div>
    ...
    <section class="ftco-section ftco-about">
			<div class="container">
	          ...
	          <div class="heading-section heading-section-white pl-md-5">
	            ...
	            <p>Sebuah lokasi kecil bernama Rembangan yang terletak di dekat Kecamatan Patrang, Desa Baratan dan menyediakan berbagai kebutuhan untuk produksi Anda. Ini adalah tempat yang mudah dan lengkap untuk menemani kegiatan produksi Anda.</p>
	            <p>Sebuah tempat yang direkomendasikan kepada masyarakat untuk dipercaya menyediakan hasil momen renungan berupa kamera yang siap menemani momen Anda dalam setiap perjalanan atau cerita dalam hidup. Kami menyediakan peralatan produksi untuk menemani setiap langkah momen Anda. Jangan ragu untuk menyewa peralatan dari kami. Kami siap menemani Anda dalam setiap langkah apapun yang Anda inginkan.</p>
		...
		<section class="ftco-section">
          ...
          <div class="col-md-7 text-center heading-section ftco-animate">
            ...
            <h2 class="mb-3">Tentang Layanan Kita!</h2>
                ...
                <p>Kita melayani persewaan untuk kebutuhan acara mulai dari acara pernikahan hingga acara prewedding dengan alat yang istimewa dan professional.</p>
              </div>
            </div>
					</div>
					<div class="col-md-3">
                ...
                <p>Kita juga melayani persewaan untuk kebutuhan instansi dengan balutan acara resmi dengan menggunakan alat yang istimewa dan professional dari persewaan kami.</p>
              </div>
            </div>
					</div>
					<div class="col-md-3">
                ...
                <p>Kita juga melayani persewaan untuk kebutuhan prewedding dengan menggunakan alat yang istimewa dan professional dari persewaan kami. Sehingga  dapat menjadikan hasil yang sangat menawan.</p>
              </div>
            </div>
					</div>
					<div class="col-md-3">
                ...
                <p>Kita juga melayani persewaan untuk kebutuhan acara kelulusan dengan menggunakan alat yang istimewa dan professional dari persewaan kami. Sehingga  dapat menjadikan hasil yang sangat elegan, menawan, dan meriah.</p>
              </div>
            </div>
					</div>
				</div>
